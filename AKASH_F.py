...
while attemps < 12345677901:
    ...
    if username == 'user' and password == 'Akash':
...
os.system('espeak -a 300 " Welcome,   to,  my,  Tools,  I, am, akash"')
...
def login():
	...
	if AKASH in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801971214358')
	elif AKASH in ['0']:
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/Nola.txt  Etc...]')
...
def passwrd():
	...
	print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mTOOL -WORK - BD- IND -NEPAL")
	AKASHj(f'\033[0;97m╔════════════════════════════════════╗')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#AKASH-Nola
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•AKASH-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m══════════════════════════════════════════════╗')
...
def superuser():
    ...
    id = "5".join(uuid)
    banner()
    DARK=requests.get("https://github.com/TAMAK-CYBER-999/AproovalAKASHF/blob/main/APROOVAL3.txt").text
    if id in DARK:
        login()
    else:
        os.system("clear")
